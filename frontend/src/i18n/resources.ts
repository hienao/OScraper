...
const zhCN = {
  translation: {
    ...
    jobs: {
      title: '刮削作业', description: '查看持久化 OpenList 执行进度、操作检查点和可恢复失败。', filter: '筛选作业', all: '全部状态', empty: '还没有刮削作业。', loadError: '加载作业失败', retryError: '重试作业失败', cancelError: '取消作业失败', retry: '从检查点重试', cancel: '取消待执行作业', jobNumber: '作业 #{{id}}', targetNumber: '目标 #{{id}}', attempts: '尝试次数', checkpoint: '检查点', preview: '预览', operations: '操作明细',
    ...
    errors: {
      ...
      codes: {
        ...
        target: { not_found: '刮削目标不存在。', invalid_id: '目标 ID 无效。', invalid_path: 'OpenList 路径无效。', invalid_library_type: '媒体类型无效。', path_outside_root: '路径超出了刮削目标根目录。', path_outside_account: '路径超出了 OpenList 账号根目录。', connection_disabled: 'OpenList 连接已停用。', job_active: '请等待活动作业完成后再修改目标。' },
